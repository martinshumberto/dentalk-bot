  ...
  <div class="col-md-12">
    <card>
      <template slot="header">
        ...
        <p class="card-category">A sua privacidade é importante para nós.</p>
      </template>
      <div class="content">
        <p>A sua privacidade é importante para nós. É política do Dentalk respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://dentalk.vendaporchat.com.br/>Dentalk</a>, e outros sites que possuímos e operamos.</p>
        ...
        <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas <a href='https://vendaporchat.com.br' target='_BLANK'>políticas de privacidade</a>.                    </p>
        <p>Você é livre para recusar a nossa solicitação de informações pessoais, entendendo que talvez não possamos fornecer alguns dos serviços desejados.</p>
        <p>O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contacto connosco.</p>
          <h4> Política de Cookies Dentalk </h4>
